...
$config['imagedir'] 	= 'themes/file/barcode/'; //string, the default is tmp/qr_codes/
$config['errorlog'] 	= 'global/tmp/logs/'; //string, the default is tmp/logs/
$config['ciqrcodelib'] 	= APPPATHS.'/third_party/qrcode/'; //string, the default is application/third_party/qr_code/
