...
class Midtrans_Setting extends BackendController {
	var $table="";
	var $post=array();
	var $sts_cetak=false;
	public function __construct()
	{
		...
		$this->addField(array('field'=>'server_key', 'size'=>30));
		$this->addField(['field'=>'production', 'input'=>'combo:search', 'combo'=>[0=>'False', 1=>'True'], 'search'=>false, 'size'=>20]);
